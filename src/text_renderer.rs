...
//!
//! let mut font = Font::from_scale_and_file(40.0, "examples/FreeSans.otf").unwrap();
...
//!
//! let text = "Text can be drawn in 2d or 3d thanks to the power of Matrices. Text is drawn without wrapping however the font struct has a function to wrap text for you.";
...
//!     frame.clear_color(0.9, 0.3, 0.5, 1.0);
//!
